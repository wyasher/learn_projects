...
import com.ash.scalachain.actor.Blockchain.{AddBlockCommand, GetChain, GetLastHash, GetLastIndex}
import com.ash.scalachain.actor.Miner.{Ready, Validate}
import com.ash.scalachain.actor.Node._
import com.ash.scalachain.blockchain._
...
class Node(nodeId: String, mediator: ActorRef) extends Actor with ActorLogging {
  ...
  override def receive: Receive =
    case TransactionMessage(transaction: Transaction, messageNodeId: String) =>
